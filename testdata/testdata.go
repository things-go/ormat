...
var SelectTestData1WithTable = []string{
	...
	"IFNULL(UNIX_TIMESTAMP(`test_data1`.`updated_at`), 0) AS `test_data1_updated_at`",
}
...
var SelectTestData1WithAbbrTable = []string{
	...
	"IFNULL(UNIX_TIMESTAMP(`td`.`updated_at`), 0) AS `td_updated_at`",
}
...
message TestData1WithTable {
  ...
  // 内容
  string test_data1_content = 3 [(things_go.seaql.field) = { type: "varchar(2048) DEFAULT NULL" }];
  // 值1,[0:空,1:键1,2:键2,3:键3]
  float test_data1_value1 = 4 [(things_go.seaql.field) = { type: "float NOT NULL DEFAULT '1'" }];
  // 值2,0:空,1:键1,2:键2,3:键3
  string test_data1_value2 = 5 [(things_go.seaql.field) = { type: "decimal(10,1) NOT NULL DEFAULT '2'" }];
  // 值3
  ...
  int64 test_data1_updated_at = 9 [(grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = { type: [ INTEGER ] }, (things_go.seaql.field) = { type: "datetime DEFAULT NULL" }];
}
...
message TestData1WithAbbrTable {
  ...
  // 内容
  string td_content = 3 [(things_go.seaql.field) = { type: "varchar(2048) DEFAULT NULL" }];
  // 值1,[0:空,1:键1,2:键2,3:键3]
  float td_value1 = 4 [(things_go.seaql.field) = { type: "float NOT NULL DEFAULT '1'" }];
  // 值2,0:空,1:键1,2:键2,3:键3
  string td_value2 = 5 [(things_go.seaql.field) = { type: "decimal(10,1) NOT NULL DEFAULT '2'" }];
  // 值3
  ...
  int64 td_updated_at = 9 [(grpc.gateway.protoc_gen_openapiv2.options.openapiv2_field) = { type: [ INTEGER ] }, (things_go.seaql.field) = { type: "datetime DEFAULT NULL" }];
}
*/
